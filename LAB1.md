...
вычисления вручную тривиальными методами (метод Гаусса, метод Крамера, с помощью обратной матрицы); эти вычисления также прилагаются к отчету лабораторной работы №1. Это значит, что результаты получились верными. 
